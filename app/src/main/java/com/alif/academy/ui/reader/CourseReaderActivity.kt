...
import com.alif.academy.ui.reader.content.ModuleContentFragment
import com.alif.academy.ui.reader.list.ModuleListFragment
...
class CourseReaderActivity : AppCompatActivity(), CourseReaderCallback{
    ...
    override fun moveTo(position: Int, moduleId: String) {
        Log.d("MEMBUKA modul kontent", "KONTENT MODUL")
